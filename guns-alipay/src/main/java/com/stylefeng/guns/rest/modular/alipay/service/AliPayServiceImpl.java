...
public class AliPayServiceImpl implements AliPayServiceAPI {
    ...
    public AliPayInfoVO getQRCode(String orderId) {
        //获取二维码地址
        String filePath = rade_precreate(orderId);
        //如果地址为空，则表示获取二维码不成功
    ...
    // 测试当面付2.0生成支付二维码
    public String rade_precreate(String orderId) {
        String filePath = "";
        OrderInfoVO orderInfoVO = orderAPI.getOrderInfoById(orderId);
        ...
        String body = "购买电影票共花费"+orderInfoVO.getOrderPrice();

        // 商户操作员编号，添加此参数可以为商户操作员做销售统计
        String operatorId = "ly";
