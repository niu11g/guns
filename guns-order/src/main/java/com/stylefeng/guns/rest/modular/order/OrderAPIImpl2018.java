...
public class OrderAPIImpl2018 implements OrderAPI {
    ...
    public OrderInfoVO saveOrderInfo(
        ...
        MoocOrder2018T mooc2018OrderT = new MoocOrder2018T();
        mooc2018OrderT.setUuid(uuid);
        mooc2018OrderT.setSeatsName(seatsName);
        mooc2018OrderT.setSeatsIds(soldSeats);
        mooc2018OrderT.setOrderUser(userId);
        mooc2018OrderT.setOrderPrice(totalPrice);
        mooc2018OrderT.setFilmPrice(filmPrice);
        mooc2018OrderT.setFilmId(filmId);
        mooc2018OrderT.setFieldId(fieldId);
        mooc2018OrderT.setCinemaId(cinemaId);

        Integer insert = moocOrder2018TMapper.insert(mooc2018OrderT);
        if(insert>0){
            //返回查询结果
            OrderInfoVO orderInfoVO = moocOrder2018TMapper.getOrderInfoById(uuid);
    ...
    public Page<OrderInfoVO> getOrderByUserId(Integer userId, Page<OrderInfoVO> orderInfo) {
        ...
        if(userId == null){
            ...
            List<OrderInfoVO> orderInfoByUserId = moocOrder2018TMapper.getOrderInfoByUserId(userId,orderInfo);
    ...
    public OrderInfoVO getOrderInfoById(String orderId) {
        ...
        OrderInfoVO orderInfoById = moocOrder2018TMapper.getOrderInfoById(orderId);
